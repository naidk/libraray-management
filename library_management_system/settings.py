...
MIDDLEWARE = [
    ...
    'library_management_app.LoginCheckMiddleWare.LoginCheckMiddleWare',
]
...
#For Custom USER
AUTH_USER_MODEL = "library_management_app.CustomUser"

# Registering Custom Backend "EmailBackEnd"
AUTHENTICATION_BACKENDS = ['library_management_app.EmailBackEnd.EmailBackEnd']
